                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12">
						<div class="single-image">
							<img src="images/latest/news1.jpg" alt="single">
						</div>
						<h3>32 Tim SMA
						...
						<blockquote>
							...
							"Futsal bukan sekadar olahraga, itu adalah perjalanan melalui keringat, kerja keras, dan kebersamaan."
						</blockquote>
						<p>Turnamen PGFC telah dimulai sejak tahun 2014 dan khusus diadakan untuk siswa SMA sederajat. Namun, dampak dari pandemi covid-19 sempat menghentikan penyelenggaraan turnamen ini.</p> 
						<p>Setelah pandemi mereda, ajang pencarian bakat dalam olahraga futsal kembali digelar. Kali ini, kompetisi tidak hanya melibatkan sekolah-sekolah di Kabupaten Gresik saja. Beberapa sekolah dari luar daerah seperti Surabaya, Sidoarjo, Mojokerto, dan Lamongan juga ikut ambil bagian.</p>
							...
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="images/latest/news2.jpg" alt="Blog single photo"></a>                                   
									</div>                                
									<h3>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="images/latest/news3.jpg" alt="Blog single photo"></a>                     
									</div>                                
									<h3>
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
									<div class="popular-post-img">
										<a href="#"><img src="images/latest/news1.jpg" alt="Blog single photo"></a>                                  
									</div>                                
									<h3>
                                                ...
                                                <div class="item-post">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                            <h4><a href="{{ route('landing.blog-single') }}">Raken develops The software</a></h4>
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 content">
                                                <div class="item-post">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
                                                            <h4><a href="{{ route('landing.blog-single') }}">TRaken develops The software</a></h4>
                                                            <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> June 28, 2017</span>
                                                        </div>
                                                    </div>
                                                </div>
