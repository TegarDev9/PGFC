                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th data-priority="1">Nama Sekolah</th>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="btn btn-secondary dropdown-item" href="route('/DataSekolah/DetailDataSekolah')">View</a>
                                                            <a class="dropdown-item edit-btn" data-id="{{$Data->id}}" data-bs-toggle="modal" data-bs-target="#exampleModal">Edit</a>
                                                            <a class="dropdown-item" href="{{ route('DataSekolah.delete', ['id' => $Data->id]) }}">Hapus</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        @endforeach
