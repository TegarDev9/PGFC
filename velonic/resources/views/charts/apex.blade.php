@extends('layouts.vertical', ['title' => 'Apex Charts', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="basic-area" class="apex-charts" data-colors="#285434"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="spline-area" class="apex-charts" data-colors="#285434,#1a2942"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="basic-boxplot" class="apex-charts" data-colors="#285434,#47ad77"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="simple-bubble" class="apex-charts" data-colors="#285434,#edc755,#fa5c7c"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="second-bubble" class="apex-charts" data-colors="#285434,#47ad77,#fa5c7c,#39afd1"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    ...
                    <div id="combo-bar-candlestick" class="apex-charts" data-colors="#285434,#edc755"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="basic-column" class="apex-charts" data-colors="#285434,#4489e4,#33b0e0"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="datalabels-column" class="apex-charts" data-colors="#285434"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="line-chart-datalabel" class="apex-charts" data-colors="#d03f3f,#285434"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="line-column-mixed" class="apex-charts" data-colors="#4489e4,#285434"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="multiple-yaxis-mixed" class="apex-charts" data-colors="#285434,#39afd1,#fa5c7c"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="simple-pie" class="apex-charts" data-colors="#285434,#6c757d,#4489e4,#d03f3f,#edc755"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="simple-donut" class="apex-charts" data-colors="#285434,#6c757d,#4489e4,#d03f3f,#edc755"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="basic-polar-area" class="apex-charts" data-colors="#285434,#6c757d,#4489e4,#d03f3f,#edc755,#33b0e0"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="basic-radialbar" class="apex-charts" data-colors="#285434"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body">
                ...
                <div dir="ltr">
                    <div id="multiple-radialbar" class="apex-charts" data-colors="#285434,#4489e4,#edc755,#33b0e0"></div>
                </div>
            </div>
            <!-- end card body-->
        </div>
