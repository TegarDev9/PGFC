        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div id="sparkline1" data-colors="#285434,#4489e4"></div>
                    </div>
                </div>
            </div> <!-- end card -->
        </div> <!-- end col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div id="sparkline2" data-colors="#285434" class="text-center"></div>
                    </div>
                </div>
            </div> <!-- end card -->
        </div> <!-- end col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div id="sparkline3" data-colors="#285434,#4489e4,#d03f3f,#716cb0"
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div id="sparkline4" data-colors="#285434,#716cb0" class="text-center"></div>
                    </div>
                </div>
            </div> <!-- end card -->
        </div> <!-- end col -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4">
                        <div id="sparkline6" data-colors="#f2f2f7,#285434" class="text-center"></div>
                    </div>
                </div>
            </div> <!-- end card -->
        </div> <!-- end col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4" style="min-height: 164px;">
                        <div id="sparkline9" data-colors="#285434,#1a2942,#d1d7d973" class="text-center"></div>
                    </div>
                </div>
            </div> <!-- end card -->
        </div> <!-- end col -->
        ...
        <div class="col-md-6 col-lg-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-center mt-4" style="min-height: 164px;">
                        <div id="sparkline10" data-colors="#d1d7d973,#1a2942,#285434" class="text-center">
                        </div>
                    </div>
                </div>
            </div> <!-- end card -->
