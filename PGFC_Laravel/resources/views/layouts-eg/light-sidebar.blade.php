@extends('layouts.vertical', ['title' => 'Light Sidebar', 'menuColor' =>'light', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="weeklysales-collapse" class="collapse pt-3 show">
                    <div dir="ltr">
                        <div id="revenue-chart" class="apex-charts" data-colors="#285434,#1a2942,#d1d7d973"></div>
                    </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="yearly-sales-collapse" class="collapse pt-3 show">
                    <div dir="ltr">
                        <div id="yearly-sales-chart" class="apex-charts" data-colors="#285434,#1a2942,#d1d7d973">
                        </div>
                    </div>
                    <div class="row text-center">
                        <div class="col">
