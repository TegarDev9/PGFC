...
<body class="authentication-bg">
                    ...
                    <div class="card overflow-hidden bg-opacity-25">
                        <div class="row g-0">
                            <div class="col-lg-6 d-none d-lg-block p-2">
                                <img src="/images/bg.png" alt="" class="img-fluid rounded h-100">
                            </div>
                            <div class="col-lg-6">
    ...
    <footer class="footer footer-alt fw-medium">
        <span class="text-dark-emphasis">
            <script>document.write(new Date().getFullYear())</script> © PGFC -  by Petrokimia Gresik
        </span>
    </footer>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            const referralCodeInput = document.querySelector("input[name='referral_code']");
            const errorSpan = document.querySelector("span[for='referral_code']");
    
            form.addEventListener("submit", function (event) {
                const referralCodeValue = referralCodeInput.value.trim();
                if (referralCodeValue === "") {
                    event.preventDefault(); 
                    errorSpan.textContent = "Kode Token harus diisi.";
                } else {
